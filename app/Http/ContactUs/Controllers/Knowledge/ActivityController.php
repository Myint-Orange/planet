...
class ActivityController extends Controller
{
    public function index()
    {
        ...
        return view('admin.knowledge.activity.index', compact('type'));
    }
    public function create()
    {
        return view('admin.knowledge.activity.create');
    }
    ...
    public function updateType(Request $request)
    {
        ...
        return redirect()->route('activity.index', compact('notification'));
    }

    // public function destroyImage($img_id, $post_id)
    // {
    //     ImageController::deletePostImageByImgId($img_id, 'name_en');
    //     return redirect()->route('activity.update', $post_id);
    // }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('activity.update', $post->id);
    }

    public function update($post_id)
    {
        $post = Post::find($post_id);
        return view('admin.knowledge.activity.edit', compact('post'));
    }
