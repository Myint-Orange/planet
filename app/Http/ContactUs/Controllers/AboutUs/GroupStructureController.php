...
class GroupStructureController extends Controller
{
    ...
    public function updateType(Request $request)
    {
        ...
        $imageName = $this->updateTypeImage($request);
        ...
        return redirect()->route('groupstructure.index', compact('notification'));
    }
    ...
    public function updateTypeImage($request)
    {
    ...
    public function updatePostImage($request)
    {
    ...
    public function updateOrgForGroup(Request $request)
    {
        dd("Arrive ");
    }
}
