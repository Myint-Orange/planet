...
////////////////////content//////////////////////
      row.cells[7].style.display = en;

      row.cells[8].style.display = th;
      
      row.cells[9].style.display = ch;
      ///////////////////////////////////
      row.cells[10].style.display = en;

      row.cells[11].style.display = th;

      row.cells[12].style.display = ch;
      }
    }
...
const deleteButtons = document.querySelectorAll('.delete-row');
    ...
    function updateFormAction(post_id) {
      var newActionRoute = `delete/${post_id}/${type.id}`;
