                                ...
                                <div class="col-12 col-lg-6 wow fadeInRight">
                                    <div class="desc-cpartner">
                                        ...
                                        <div class="content-editor">
                                            <span style="color: #000;" class="clinic-lab" data-th="ชื่อคลินิก :" data-en="Clinic name :" data-ch="Clinic name :">ชื่อคลินิก :</span> <span class="clinic" data-th="{!! array_slice(explode('##', $post->contents[0]->content_th), 1, 1)[0] !!}" data-en="{!! array_slice(explode('##', $post->contents[0]->content_en), 1, 1)[0] !!}" data-ch="{!! array_slice(explode('##', $post->contents[0]->content_ch), 1, 1)[0] !!}">
                                                {!! array_slice(explode('##', $post->contents[0]->content_th), 1, 1)[0] !!}</span> <br>
                                            <span style="color: #000;" class="typeBus-lab" data-th="ประเภทธุรกิจ :" data-en="Type Of Business :" data-ch="Type Of Business :">ประเภทธุรกิจ :</span><span class="typeBus" data-th="{!! array_slice(explode('##', $post->contents[0]->content_th), 2, 1)[0] !!}" data-en="{!! array_slice(explode('##', $post->contents[0]->content_en), 2, 1)[0] !!}" data-ch="{!! array_slice(explode('##', $post->contents[0]->content_ch), 2, 1)[0] !!}">
                                                {!! array_slice(explode('##', $post->contents[0]->content_th), 2, 1)[0] !!}</span> <br>
                                            <span style="color: #000;" class="date-of-op-lab" data-th="วันเดือนปีที่เปิดดำเนินการ :" 
                                            data-en="Date Of Operation :" data-ch="Date Of Operation :">วันเดือนปีที่เปิดดำเนินการ :</span><span class="date-of-op">
                                                {!! date('F j, Y', strtotime($post->created_at)) !!} </span><br>
                                            <span style="color: #000;" class="branch-lab" data-th="ชื่อสาขา :" data-en="Branch Name :" data-ch="Branch Name :">ชื่อสาขา :</span><span class="branch" data-th="{!! array_slice(explode('##', $post->contents[0]->content_th), 4, 1)[0] !!}" data-en="{!! array_slice(explode('##', $post->contents[0]->content_en), 4, 1)[0] !!}" data-ch="{!! array_slice(explode('##', $post->contents[0]->content_ch), 4, 1)[0] !!}">
                                                {!! array_slice(explode('##', $post->contents[0]->content_th), 4, 1)[0] !!}</span> <br>
                                            <span style="color: #000;" class="location-lab" data-th="เว็บไซต์ :" data-en="Location :" data-ch="Location :">สถานที่ตั้ง :</span><span class="location" data-th="{!! array_slice(explode('##', $post->contents[0]->content_th), 5, 1)[0] !!}" data-en="{!! array_slice(explode('##', $post->contents[0]->content_en), 5, 1)[0] !!}" data-ch="{!! array_slice(explode('##', $post->contents[0]->content_ch), 5, 1)[0] !!}">
                                                {!! array_slice(explode('##', $post->contents[0]->content_th), 5, 1)[0] !!}</span> <br>
                                            <span style="color: #000;" class="website-lab" data-th="เว็บไซต์ :" data-en="Website :" data-ch="Website :">เว็บไซต์ :</span><span class="website" data-th="{!! array_slice(explode('##', $post->contents[0]->content_th), 6, 1)[0] !!}" data-en="{!! array_slice(explode('##', $post->contents[0]->content_en), 6, 1)[0] !!}" data-ch="{!! array_slice(explode('##', $post->contents[0]->content_ch), 6, 1)[0] !!}">
                                                {!! array_slice(explode('##', $post->contents[0]->content_th), 6, 1)[0] !!} </span><br>
                                            <span style="color: #000;" class="telephone-lab" data-th="เบอร์โทรศัพท์ :" data-en="Telephone Number :" data-ch="Telephone Number :">เบอร์โทรศัพท์ :</span><span class="telephone" data-th="{!! array_slice(explode('##', $post->contents[0]->content_th), 7, 1)[0] !!}" data-en="{!! array_slice(explode('##', $post->contents[0]->content_en), 7, 1)[0] !!}" data-ch="{!! array_slice(explode('##', $post->contents[0]->content_ch), 7, 1)[0] !!}">
                                                {!! array_slice(explode('##', $post->contents[0]->content_th), 7, 1)[0] !!}</span> <br>
                                            <span style="color: #000;" class="email-lab" data-th="อีเมล :" data-en="E-mail :" data-ch="E-mail :">อีเมล :</span> <span class="email" data-th="{!! array_slice(explode('##', $post->contents[0]->content_th), 8, 1)[0] !!}" data-en="{!! array_slice(explode('##', $post->contents[0]->content_en), 8, 1)[0] !!}" data-ch="{!! array_slice(explode('##', $post->contents[0]->content_ch), 8, 1)[0] !!}">
                                                {!! array_slice(explode('##', $post->contents[0]->content_th), 8, 1)[0] !!} </span><br>
                                            <span style="color: #000;" class="officehour-lab" data-th="เวลาทำการ :" data-en="Office Hours :" data-ch="Office Hours :">เวลาทำการ :</span><span class="officehour" data-th="{!! array_slice(explode('##', $post->contents[0]->content_th), 9, 1)[0] !!}" data-en="{!! array_slice(explode('##', $post->contents[0]->content_en), 9, 1)[0] !!}" data-ch="{!! array_slice(explode('##', $post->contents[0]->content_ch), 9, 1)[0] !!}">
                                                {!! array_slice(explode('##', $post->contents[0]->content_th), 9, 1)[0] !!}</span> <br>
                                            <span style="color: #000;" class="area-lab" data-th="ขนาดพื้นที่ :" data-en="Area Size :" data-ch="Area Size :">ขนาดพื้นที่ :</span><span class="area" data-th="{!! array_slice(explode('##', $post->contents[0]->content_th), 10, 1)[0] !!}" data-en="{!! array_slice(explode('##', $post->contents[0]->content_en), 10, 1)[0] !!}" data-ch="{!! array_slice(explode('##', $post->contents[0]->content_ch), 10, 1)[0] !!}">
