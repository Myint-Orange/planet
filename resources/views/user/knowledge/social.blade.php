                        ...
                        <div class="col-12">
                            <figure>
                                ...
                                <a href="{{ $videoLink }}" data-fancybox class="cover-media" title="Play Video">
                                    <div class="photo-media"><img src="{{asset('storage/posts/'.$posts[0]->imgname) }}" alt=""></div>
            ...
            <div class="row media-post2">
                <div class="col-12 col-lg-6 wow fadeInLeft">
                    <a href="{{$videoLink}}" data-fancybox class="cover-media-all" title="Play Video">
                        <div class="photo-media"><img src="{{asset('storage/posts/'.$posts[1]->imgname) }}" alt=""></div>
            ...
            <div class="col-12 media-post3">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-12 col-lg-6 wow fadeInRight">
                            <a href="{{$videoLink}}" data-fancybox class="cover-media-all" title="Play Video">
                                <div class="photo-media"><img src="{{asset('storage/posts/'.$posts[2]->imgname) }}" alt=""></div>
                                <div class="icon-play"><i class="bi bi-play-circle"></i></div>
                            </a>
                        </div>
                    </div>
        ...
        <section class="container">
            <div class="row all-media">
                ...
                <div class="col-12 col-md-6 wow fadeInDown item-media">
                    <figure>
                        <a href="{{$videoLink}}" data-fancybox class="cover-media-all" title="Play Video">
                            <div class="photo-media"><img src="{{asset('storage/posts/'.$post->imgname) }}" alt=""></div>
                            <div class="icon-play"><i class="bi bi-play-circle"></i></div>
                        </a>
                        <figcaption class="hello">
                            <div class="desc-postmedia">
                                ...
                                <div class="content-editor">
                                    <p style="color: #000; font-weight: 500; font-size: 1.1rem;" class="postSubTitle" data-th="{{$post->titles[1]->title_th}}" data-en="{{$post->titles[1]->title_en}}" data-ch="{{$post->titles[1]->title_ch}}">
                                        {{$post->titles[1]->title_th}}
                                    </p>
                                    <p class="postContent" data-th="{{$post->contents[0]->content_th}}" data-en="{{$post->contents[0]->content_en}}" data-ch="{{$post->contents[0]->content_ch}}">
