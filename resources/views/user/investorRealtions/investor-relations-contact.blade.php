            ...
            <div class="row wrap-homehistory">
                <div class="col-12 col-md-5 col-lg-4 wow fadeInLeft">
                    <div class="photo-homehistory">
                        <div>CONTACT</div>
                        <figure><img src="{{ asset('/images/'.$inContact->image)}}" alt=""></figure>
                    </div>
                </div>
                <div class="col-12 col-md-7 col-lg-8 wow fadeInRight">
                    <div class="ir-contact contact-info">
                        <h2>{{ $inContact->title }}</h2>
                        <h3>{{ $inContact->subtitle }}</h3>
                        <address>{{ $inContact->address }}</address>
                        <div class="info-detail">
                            <div><span><i class="bi bi-telephone"></i> โทร. </span> {{ $inContact->phone }}</div>
                            <div><span><i class="bi bi-envelope"></i> อีเมล์ </span> {{ $inContact->email }}</div>
                            <div><a href="{{ $inContact->locationmap }}" target="_blank"><i class="bi bi-geo-alt"></i> <span>ดูแผนที่</span></a></div>
                        </div>
                    </div>
                </div>
            </div>
...
<section class="row wow fadeInDown">
    <div class="col-12 googlemaps">
        <div class="ratio ratio-21x9">
            {{ $inContact->locationmap }}
        {{-- <iframe src="{{ $inContact->locationmap }}" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>/ --}}
