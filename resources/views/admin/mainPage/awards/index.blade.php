  ...
  <div class="container-fluid">
    <div class="card card-default">
           <div class="card-header">
             <h3 class="card-title">Awards Panel</h3>
           </div>
           <div class="card-body">
            <div class="row"> 
              </div>
              <form action='{{route('awards.editAwards')}}' method="post" enctype="multipart/form-data" id='regform'>
                @csrf  
                        ...
                        <div class="row">
                          <div class="col-md-4">
                            <div class="form-group">
                              ...
                              <textarea id="summernote1" name="subTitle_th" class="form-control">{{$type->typeTitles[1]->title_th}} </textarea>
                            </div>
                          </div>
                          <div class="col-md-4">
                          <!-- /.form-group -->
                              <div class="form-group">
                                ...
                                <textarea id="summernote2" name="subTitle_en" class="form-control">{{$type->typeTitles[1]->title_en}} </textarea>
                              </div>
                          <!-- /.form-group -->
                          </div>
                          <div class="col-md-4">
                            <!-- /.form-group -->
                                <div class="form-group">
                                  ...
                                  <textarea id="summernote3" name="subTitle_ch" class="form-control">{{$type->typeTitles[1]->title_ch}} </textarea>
                                </div>
                            <!-- /.form-group -->
                            </div>
