      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card card-primary card-outline">
            ...
            <div class="card-body">
              <form action='{{route('groupstructure.editImage')}}' method="post" enctype="multipart/form-data" id='regform'>
                @csrf
            ...
            <div class="card-body">
              <div class="tab-content" id="custom-tabs-one-tabContent">
                ...
                <div class="tab-pane fade show active" id="custom-tabs-one-messages" role="tabpanel" aria-labelledby="custom-tabs-one-messages-tab">
                  ...
                  <form action='{{route('groupstructure.edit')}}' method="post" enctype="multipart/form-data" id='regform'>
                    @csrf
                    <input type="hidden" name="post_id" value="{{$post->id}}">
                    <div class="row">
                      <div class="col-sm-6">
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <input type="text" name="subTitle_th" class="form-control" placeholder="Enter ..." value="{{$post->titles[1]->title_th}}">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <input type="text" name="subTitle_en" class="form-control" placeholder="Enter ..." value="{{$post->titles[1]->title_en}}">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <input type="text" name="subTitle_ch" class="form-control" placeholder="Enter ..." value="{{$post->titles[1]->title_ch}}">
                        </div>
                      </div>
                    </div>
              ...
              <div class="row">
                <div class="col-12 col-sm-6">
                  <div class="form-group">
                    <button type="submit" class="btn btn-primary" id="btn-mission">Save</button>
                    <a href="{{route('groupstructure.index')}}" class="btn btn-default " id="btn-mission"> Exit </a>
                  </div>
                </div>
              </div>
            </div>
