...
<div class="content-wrapper">
  ...
  <section class="content">
    <div class="container-fluid">
      ...
      <form action='{{route('businesspost.store')}}' method="post" enctype="multipart/form-data" id='regform'>
        @csrf
        <input type="hidden" name="type_id" value="{{$type->id}}">
        <div class="col-md-12">
          <div class="card card-default">
            <div class="card-header">
              <h3 class="card-title">Create Business Post For {{$type->typeTitles[0]->title_en}}</h3>
            </div>
                ...
                <div class="bs-stepper-header" role="tablist">
                  ...
                  <div class="step" data-target="#profile-part">
                    <button type="button" class="step-trigger" role="tab" aria-controls="logins-part" id="logins-part-trigger">
                      ...
                      <span class="bs-stepper-label">Add Post Photo </span>
                    </button>
                  </div>
                  <div class="line"></div>
