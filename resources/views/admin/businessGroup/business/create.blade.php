  ...
  <section class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="row">
          <div class="col-12">
            <h4>Create New Embryo Business </h4>
          </div>
        </div>
      </div>
      <form action="{{route('business.store')}}" method="post" enctype="multipart/form-data" id='regform'>
        @csrf
                ...
                <div class="bs-stepper-header" role="tablist">
                  ...
                  <div class="step" data-target="#profile-part">
                    <button type="button" class="step-trigger" role="tab" aria-controls="logins-part" id="logins-part-trigger">
                      ...
                      <span class="bs-stepper-label">Add Banner Photo of Business</span>
                    </button>
                  </div>
                  <div class="line"></div>
                              ...
                              <div class="row">
                                ...
                                <div class="col-sm-6">
                                  <div class="form-group">
                                    ...
                                    <textarea id="summernote1" name="content_th" class="form-control" required></textarea>
                                  </div>
                                </div>
                              </div>
                              ...
                              <div class="row">
                                ...
                                <div class="col-sm-6">
                                  <div class="form-group">
                                    ...
                                    <textarea id="summernote2" name="content_en" class="form-control" required></textarea>
                                  </div>
                                </div>
                              </div>
                              ...
                              <div class="row">
                                ...
                                <div class="col-sm-6">
                                  <div class="form-group">
                                    ...
                                    <textarea id="summernote3" name="content_ch" class="form-control" required></textarea>
                                  </div>
                                </div>
                              </div>
