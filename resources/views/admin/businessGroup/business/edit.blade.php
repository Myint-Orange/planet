@extends('layout.app')
@section('title') Embryo Business @endsection
@section('css-place')
  ...
  <section class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="row">
          <div class="col-12">
            <h4>Edit Embryo Business </h4>
          </div>
        </div>
      </div>
      <form action='{{route('business.edit')}}' method="post" enctype="multipart/form-data" id='regform'>
        @csrf
                ...
                <div class="bs-stepper-header" role="tablist">
                  ...
                  <div class="step" data-target="#profile-part">
                    <button type="button" class="step-trigger" role="tab" aria-controls="logins-part" id="logins-part-trigger">
                      ...
                      <span class="bs-stepper-label">Edit Cover Photo </span>
                    </button>
                  </div>
                  <div class="line"></div>
                  <div class="step" data-target="#title-part">
                    <button type="button" class="step-trigger" role="tab" aria-controls="information-part" id="information-part-trigger">
                      ...
                      <span class="bs-stepper-label">Edit Title And Content</span>
                    </button>
                  </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-2">
                        <div class="form-group">
                          <a href="{{route('business.index')}}" class="btn btn-default btn-lg " id="btn-mission">Exit</a>
                        </div>
                      </div>
                    </div>
                              ...
                              <div class="row">
                                <div class="col-sm-6">
                                  <div class="form-group">
                                    ...
                                    <textarea name="title_th" class="form-control" required>{{$type->typeTitles[0]->title_th}}</textarea>
                                  </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                  <div class="form-group">
                                    ...
                                    <textarea id="summernote1" name="content_th" class="form-control" required>{{ $type->typeContents[0]['content_th'] ?? '' }}</textarea>
                                  </div>
                                </div>
                              </div>
                              ...
                              <div class="row">
                                <div class="col-sm-6">
                                  <div class="form-group">
                                    ...
                                    <textarea name="title_en" class="form-control" required>{{$type->typeTitles[0]->title_en}}</textarea>
                                  </div>
                                </div>
                                <div class="col-sm-6">
                                  <div class="form-group">
                                    <label>Content (English)</label>
                                    <textarea id="summernote2" name="content_en" class="form-control" required>{{ $type->typeContents[0]['content_en'] ?? '' }}</textarea>
                                  </div>
                                </div>
                              </div>
                              ...
                              <div class="row">
                                <div class="col-sm-6">
                                  <div class="form-group">
                                    ...
                                    <textarea name="title_ch" class="form-control" required>{{$type->typeTitles[0]->title_ch}}</textarea>
                                  </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                  <div class="form-group">
                                    ...
                                    <textarea id="summernote3" name="content_ch" class="form-control" required>{{ $type->typeContents[0]['content_ch'] ?? '' }}</textarea>
                                  </div>
                                </div>
                              </div>
