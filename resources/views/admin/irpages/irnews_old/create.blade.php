      ...
      <div class="col-md-12">
        ...
        <div class="card card-info">
          <div class="card-header">
            <h3 class="card-title">IR News Information</h3>
          </div>
          <form action='{{route('news.store')}}' method="post" enctype="multipart/form-data" id='regform'>
            @csrf
            @method('post')
            <div class="card-body">
              <div class="row">
                <div class="col-md-8">
                    <div class="form-group">
                      ...
                      <input type="date" class="form-control" id="name" name="name" placeholder="Enter City Name.." >
                    </div>
                </div>
              </div>  
              <div class="row">
                <div class="col-md-8">
                    <div class="form-group">
                      ...
                      <textarea id="summernote1" name="headline" class="form-control" required></textarea>
                    </div>
                </div>
              </div>  
            <div class="card-footer">
              <button type="submit" class="btn btn-primary">Submit</button>
              <a href="{{route('news.indexs')}}"  class="btn btn-default">Exist</a>
            </div>
          </form>
        </div>
      </div>
