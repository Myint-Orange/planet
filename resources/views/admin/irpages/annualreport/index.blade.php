                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-primary card-outline">
                            ...
                            <div class="card-body">
                                @if ($type)
                                    <form action='{{ route('user.annualReport.editBanner') }}' method="post"
                                        enctype="multipart/form-data" id='regform'>
                                        @csrf
                                        <div class="row justify-content-center">
                                            <input type="hidden" name="id" value="{{ $type->id }}" />
                                            <img src="{{ asset('/images/' . $type->image) }}" id="preview"
                                            ...
                                            <div class="col-md-6 d-flex align-items-center">
                                                <div class="custom-file mr-2">
                                                    <input type="file" class="custom-file-input" id="image"
                                                        name="image" onchange="updateLabel('image','preview')"
                                                        style="padding: 10px;">
                                                    <label class="custom-file-label" for="image">Add Image For About
                                                        Us</label>
                                                </div>
                                ...
                                @else
                                    <form action='{{ route('user.annualReport.store') }}' method="post"
                                        enctype="multipart/form-data" id='regform'>
                                        @csrf
                                        <div class="row justify-content-center">
                                            ...
                                            <div class="col-md-6 d-flex align-items-center">
                                                <div class="custom-file mr-2">
                                                    <input type="file" class="custom-file-input" id="image"
                                                        name="image" onchange="updateLabel('image','preview')"
                                                        style="padding: 10px;">
                                                    <label class="custom-file-label" for="image">Add Image For
                                                        ShareHolderBanner</label>
                                                </div>
                                                <button type="submit" class="btn btn-primary"
                                                    id="btn-mission">Save</button>
                                            </div>
