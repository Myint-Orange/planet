@extends('layout.app')
@section('title')Management&Analysis @endsection
@section('css-place')
<link rel="stylesheet" href="{{asset('dist/css/custom.css')}}"> @endsection
@section('contents')
<div class="content-wrapper">
  <form action='{{route('IRFinancial.storeFile')}}' method="post" enctype="multipart/form-data" id='regform'>
    @csrf
            ...
            <div class="card card-primary card-outline">
              ...
              <div class="card-body">
                ...
                <div class="row justify-content-center">
                  ...
                  <div class="col-sm-1">
                    <div class="form-group">
                      <a href="{{route('IRFinancial.index')}}" class="btn btn-default " id="btn-mission">Exit</a>
                    </div>
                  </div>
                </div>
