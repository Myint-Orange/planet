                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-info">
                            <div class="card-header">
                                <h3 class="card-title">IR Share Holder Meeting  Information (Attachment)</h3>
                            </div>
                            <form action='{{ route('shareholdermeeting.attachementstore') }}' method="post" enctype="multipart/form-data"
                                id='regform'>
                                @csrf
                                @method('post')
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1"> Purchase Issuse Description</label>
                                                <input type="text" class="form-control" id="name" name="name"
                                                    placeholder="Enter Purchase Issuse Description..">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                    ...
                                    <div class="card-footer">
                                        ...
                                        <a href="{{ route('shareholdermeeting.index') }}" class="btn btn-default">Exist</a>
                                    </div>
                            </form>
                        </div>
                    </div>
