                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-info">
                            <div class="card-header">
                                <h3 class="card-title">IR Share Holder Meeting  Information (Criteria)</h3>
                            </div>
                            <form action='{{ route('shareholdermeeting.criteriastore') }}' method="post" enctype="multipart/form-data"
                                id='regform'>
                                @csrf
                                @method('post')
                                <div class="card-body">
