                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="card card-info">
                            ...
                            <form action='{{ route('finicialinformation.updated', ['id' => $post->id]) }}' method="post"
                                        ...
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="menu_en" class="form-control"
                                                    placeholder="Enter ..."  value=" {{ $post->rationame_en }}">
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="menu_th" class="form-control"
                                                    placeholder="Enter ..." value=" {{ $post->rationame_th }}">
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="menu_ch" class="form-control"
                                                    placeholder="Enter ..." value=" {{ $post->rationame_ch }}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="yearone" class="form-control"
                                                    placeholder="Enter ..." value=" {{ $post->yearone }}">
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="yeartwo" class="form-control"
                                                    placeholder="Enter ..." value="{{ $post->yeartwo }}">
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="yearthree" class="form-control"
                                                    placeholder="Enter ..." value="{{ $post->yearthree }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
