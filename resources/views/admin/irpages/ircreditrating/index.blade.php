      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card card-primary card-outline">
            ...
            <div class="card-body">
              @if ($type)
              <form action='{{route('creditrating.editBanner')}}' method="post" enctype="multipart/form-data" id='regform'>
                @csrf
              ...
              @else
               <form action='{{route('creditrating.stored')}}' method="post" enctype="multipart/form-data" id='regform'>
                @csrf
                <div class="row justify-content-center">
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              ...
              <a href="{{route('creditrating.create')}}" class="btn btn-primary">
                      ...
                      <td>
                        <div class="btn-group">
                          ...
                          <div class="dropdown-menu" role="menu">
                            <a class="dropdown-item" href="{{route('creditrating.editBanner',$post->id)}}">Edit</a>
