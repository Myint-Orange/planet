      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card card-primary card-outline">
            ...
            <div class="card-body">
              @if ($type)
              <form action='{{route('dividendpolicy.storeded')}}' method="post" enctype="multipart/form-data" id='regform'>
                @method('POST')
                @csrf
              ...
              @else
               <form action='{{route('dividendpolicy.stored')}}' method="post" enctype="multipart/form-data" id='regform'>
                @csrf
                <div class="row justify-content-center">
