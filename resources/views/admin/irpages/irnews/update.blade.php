                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="card card-info">
                            ...
                            <form action='{{ route('news.updated') }}' method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                ...
                                                <input type="date" class="form-control" value="{{ $post->created }}"
                                                    id="name" name="name">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                ...
                                                <textarea id="summernote1" name="headline" class="form-control" value="{{ $post->headline }}" required></textarea>
                                            </div>
                                        </div>
                                    </div>
