        ...
        <div class="col-md-12">
          <div class="card card-primary card-outline">
            <div class="card-header">
              ...
              IR Share Holder Meeting
              </h3>
            </div>
            <div class="card-body">
              @if ($type)
              <form action='{{route('shareholdermeeting.editBanner')}}' method="post" enctype="multipart/form-data" id='regform'>
                @csrf
              ...
              @else
               <form action='{{route('shareholdermeeting.storeBanner')}}' method="post" enctype="multipart/form-data" id='regform'>
                @csrf
                <div class="row justify-content-center">
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              ...
              <a href="{{route('shareholdermeeting.create')}}" class="btn btn-primary">
                <i class="fas fa-plus"></i> Add New Invitation letter
              </a>
                      ...
                      <td>
                        <div class="btn-group">
                          ...
                          <div class="dropdown-menu" role="menu">
                            <a class="dropdown-item" href="{{route('shareholdermeeting.editBanners',$post->id)}}">Edit</a>
 ...
 $(document).ready(function() {
   $('.delete-row').click(function(event) {
     ...
     if (confirm("Are you sure you sure to delete this row?")) {
       window.location.href = "{{ route('shareholdermeeting.destroyPostd', ':id') }}".replace(':id', postId);
     }
   });
 });
