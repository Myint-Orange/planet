      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card card-primary card-outline">
            ...
            <div class="card-body">
              @if ($type)
              <form action='{{route('emailNotification.editBanner')}}' method="post" enctype="multipart/form-data" id='regform'>
                @csrf
              ...
              @else
               <form action='{{route('emailNotification.store')}}' method="post" enctype="multipart/form-data" id='regform'>
                @csrf
                <div class="row justify-content-center">
