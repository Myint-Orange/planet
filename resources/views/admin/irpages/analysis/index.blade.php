        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              ...
              <a href="{{route('IRAnalysis.createFile')}}" class="btn btn-primary">
                <i class="fas fa-plus"></i> Add
              </a>

              <div class="card-body">
                <h3 class="card-title"><b>Management Discussion & Analysis</b></h3>
                      ...
                      <td>
                        <div class="btn-group">
                          ...
                          <div class="dropdown-menu" role="menu">
                            <a class="dropdown-item" href="{{route('IRAnalysis.updateFile',$post->id)}}">Edit</a>
  ...
  $(document).ready(function() {
    $('.delete-row').click(function(event) {
      ...
      if (confirm("Are you sure you sure to delete this row?")) {
        window.location.href = "{{ route('IRAnalysis.destroyFile', ':id') }}".replace(':id', postId);
      }
    });
  });
