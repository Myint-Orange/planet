                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="card card-info">
                            ...
                            <form action='{{ route('purchase.updated', ['id' => $post->id]) }}' method="post"
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="name" name="name"
                                                    placeholder="Enter Purchase Issuse Description.." value="{{ $post->name }}">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="file" class="form-control" id="pdflink" name="pdflink"
                                                    placeholder="Please Select PDF File.." value="{{ $post->pdflink }}">
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-footer">
                                        ...
                                        <a href="{{ route('purchase.index') }}" class="btn btn-default">Exist</a>
                                    </div>
                            </form>
                        </div>
                    </div>
