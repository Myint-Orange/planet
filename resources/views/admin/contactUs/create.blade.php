                  ...
                  <div id="gallery-part" class="content" role="tabpanel" aria-labelledby="information-part-trigger">
                    <div class="card card-default">
                      ...
                      <div class="card-body">
                        <div class="row">
                          <div class="col-sm-6">
                            <video id="video-preview" controls width="400" height="300"></video>
                          </div>
                          <div class="col-sm-6">
                            <div id="youtube-preview-container">
                              <iframe id="youtube-preview" width="400" height="300" src="" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                            </div>
                          </div>
                        </div>
                      </div>
