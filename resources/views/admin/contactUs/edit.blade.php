                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="col-sm-6">
                            ...
                            <video id="video-preview" controls width="400" height="300">
                          ...
                          <div class="col-sm-6">
                            <div id="youtube-preview-container">
                              <iframe id="youtube-preview" width="400" height="300" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen @if(isset($post->vedios)&&count($post->vedios) > 0)
