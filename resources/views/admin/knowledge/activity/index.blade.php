    ...
    <div class="container-fluid">
      <div class="card card-default">
        <div class="card-header">
          <h3 class="card-title">New And Activity Banner Panel</h3>
        </div>
        <div class="card-body">
          <div class="row">
          </div>
          <form action='{{route('activity.updateType')}}' method="post" enctype="multipart/form-data" id='regform'>
            @csrf
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              ...
              <div class="card-body">
                <h3 class="card-title">New And Activity <b> EMBRYO</b></h3>
                      ...
                      <td>
                        <div class="btn-group">
                          ...
                          <div class="dropdown-menu" role="menu">
                            <a class="dropdown-item" href="{{route('activity.update',$post->id)}}">Edit</a>
  ...
  $(document).ready(function() {
    ...
    $('.delete-row').click(function(event) {
      ...
      if (confirm("Are you sure you want to delete this row?")) {
        ...
        window.location.href = "{{ route('activity.destroy', ':id') }}".replace(':id', postId);
      }
    });
  });
