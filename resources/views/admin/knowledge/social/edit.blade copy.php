...
<div class="content-wrapper">
  ...
  <section class="content">
    <div class="container-fluid">
      ...
      <form action='{{route('social.edit')}}' method="post" enctype="multipart/form-data" id='regform'>
        @csrf
              ...
              <div class="bs-stepper">
                ...
                <div class="bs-stepper-content">
                  ...
                  <div id="profile-part" class="content" role="tabpanel" aria-labelledby="logins-part-trigger">
                    <div class="card-body">
                      ...
                      <div class="row justify-content-center">
                        <img src="{{ Storage::url('posts/'.$post->imgname)}}" class="img-fluid mx-auto" alt="..." style="height: 300px; width: 650px;" id="preview">
                      </div>
                              ...
                              <div class="row">
                                <div class="col-sm-12">
                                  <div class="form-group">
                                    ...
                                    <textarea name="content_th" class="form-control" required>{{$post->contents[0]->content_th}}</textarea>
                                  </div>
                                </div>
                              </div>
                            </div>
                            <div class="row">
                              <div class="col-sm-12">
                                <div class="form-group">
                                  ...
                                  <textarea name="content_en" class="form-control" required>{{$post->contents[0]->content_en}}</textarea>
                                </div>
                              </div>
                            </div>
                            <div class="row">
                              <div class="col-sm-12">
                                <div class="form-group">
                                  ...
                                  <textarea name="content_ch" class="form-control" required>{{$post->contents[0]->content_ch}}</textarea>
                                </div>
                              </div>
                            </div>
                  ...
                  <div id="gallery-part" class="content" role="tabpanel" aria-labelledby="information-part-trigger">
                        ...
                        <div class="card-body table-responsive pad">
                          <div class="btn-group btn-group-toggle" data-toggle="buttons">
                            <label class="btn btn-secondary active">
                              <input type="radio" name="options" id="option_a1" autocomplete="off"> Vedio File
                            </label>
                            <label class="btn btn-secondary">
                              <input type="radio" name="options" id="option_a2" autocomplete="off" checked> YouTube
                            </label>
                    ...
                    <div class="row">
                      <div class="col-sm-12" id="vedio">
                        <div class="card card-default">
                          <div class="card-header">
                            <div class="row">
                              <div class="col-sm-4">
                                <h4 class="card-title">Video File For Media</h4>
                              </div>
                              <div class="col-sm-6">
                                <input type="file" class="custom-file-input" id="video" name="video">
                                <label class="custom-file-label" for="video">Add Video</label>
                              </div>
                              <div class="col-sm-2">
                          ...
                          <div class="card-body">
                            <div class="row">
                              ...
                              <div class="col-sm-12 text-center">
                                <i class="fas fa-times-circle fa-2x" data-vid-id="{{$post->vedios[0]->id}}" style="color: red;" onclick="deleteVedio({{$post->id}})"></i>
                                <video id="video-preview" controls width="600" height="400">
                                  <source @if(isset($post->vedios) && count($post->vedios) > 0)

                                  src="{{ Storage::url('vedios/'.$post->vedios[0]->name) }}"
                                  @endif
                                  type="video/mp4">
                                </video>
                            ...
                            <div class="row">
                              ...
                              <div class="col-sm-12 text-center">
                                <div id="youtube-preview-container">
                                  <i class="fas fa-times-circle fa-2x" data-vid-id="{{$post->vedios[0]->id}}" style="color: red;" onclick="deleteYouTubelink({{$post->id}})"></i>
                                  <iframe id="youtube-preview" width="600" height="400" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen @if(isset($post->vedios)&&count($post->vedios) > 0)
                                    src="{{ $post->vedios[0]->youtube }}"
                                    @endif
                                    ></iframe>
                                </div>
                              </div>
