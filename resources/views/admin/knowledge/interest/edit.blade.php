...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <form action='{{route('interest.edit')}}' method="post" enctype="multipart/form-data" id='regform'>
      @csrf
        ...
        <div class="col-md-12">
          <div class="card card-default">
            <div class="card-header">
              <h3 class="card-title">Interesting facts from EMBRYO  </h3>
            </div>
              ...
              <div class="bs-stepper">
                ...
                <div class="bs-stepper-content">
                  ...
                  <div id="title-part" class="content" role="tabpanel" aria-labelledby="information-part-trigger">
                    <div class="form-group">
                      <label for="exampleInputFile">Edit Interesting facts from EMBRYO Title</label>
                  ...
                  <div id="content-part" class="content" role="tabpanel" aria-labelledby="information-part-trigger">
                    <div class="form-group">
                      <label for="exampleInputFile">Edit Interesting facts from EMBRYO Content</label>
                      <div class="input-group">
                        <div class="card-body">
                          <div class="tab-content" id="custom-tabs-one-tabContent">
                            <div class="tab-pane fade show active" id="custom-tabs-one-messages" role="tabpanel" aria-labelledby="custom-tabs-one-messages-tab">           
