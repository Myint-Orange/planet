@extends('layout.app')
@section('title') Interesting fact @endsection
    ...
    <div class="container-fluid">
      <div class="card card-default">
        <div class="card-header">
          <h3 class="card-title">Interesting Facts Banner Panel</h3>
        </div>
        <div class="card-body">
          <div class="row">
          </div>
          <form action='{{route('interest.updateType')}}' method="post" enctype="multipart/form-data" id='regform'>
            @csrf
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              ...
              <a href="{{route('interest.create')}}" class="btn btn-primary">
                <i class="fas fa-plus"></i> Add
              </a>

              <div class="card-body">
                <h3 class="card-title">Interesting Facts <b> EMBRYO</b></h3>
                      ...
                      <td>
                        <div class="btn-group">
                          ...
                          <div class="dropdown-menu" role="menu">
                            <a class="dropdown-item" href="{{route('interest.update',$post->id)}}">Edit</a>
                            <a class="dropdown-item delete-row" href="{{route('interest.destroy',$post->id)}}" id="delete-post-{{$post->id}}">Delete</a>
                          </div>
                      </td>
                    </tr>
                    @endforeach
  ...
  $(document).ready(function() {
    ...
    $('.delete-row').click(function(event) {
      ...
      if (confirm("Are you sure you want to delete this row?")) {
        ...
        window.location.href = "{{ route('interest.destroy', ':id') }}".replace(':id', postId);
      }
    });
  });
