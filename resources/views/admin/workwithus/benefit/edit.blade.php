...
<div class="content-wrapper">
  ...
  <section class="content">
    <div class="container-fluid">
      ...
      <form action='{{route('benefit.edit')}}' method="post" enctype="multipart/form-data" id='regform'>
        @csrf
        <input type="hidden" name="post_id" value="{{$post->id}}"> 
          <div class="col-md-12">
            <div class="card card-default">
              <div class="card-header">
                <h3 class="card-title">Edit Post welfare benefit</h3>
              </div>
                  ...
                  <div class="bs-stepper-header" role="tablist">
                    ...
                    <div class="step" data-target="#profile-part">
                      <button type="button" class="step-trigger" role="tab" aria-controls="logins-part" id="logins-part-trigger">
                        ...
                        <span class="bs-stepper-label">Edit Post Photo And Title  </span>
                      </button>
                    </div>
                         ...
                         <div class="row">   
                          <div class="col-sm-4">
                              <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" name='title_th' id="inputTitle" placeholder="Enter Title..."  value="{{$post->titles[0]->title_th}}" required>
                                </div>
                              </div>   
                            <div class="col-sm-4">
                              <div class="form-group">
