@extends('layout.app')
@section('title') welfare benefit @endsection
    ...
    <div class="container-fluid">
      <div class="card card-default">
        <div class="card-header">
          <h3 class="card-title">Welfare Benefit Banner Panel</h3>
        </div>
        <div class="card-body">
          <div class="row">
          </div>
          <form action='{{route('benefit.updateType')}}' method="post" enctype="multipart/form-data" id='regform'>
            @csrf
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <textarea name="subTitle_th" class="form-control" required>{{$type->typeTitles[1]->title_th}}</textarea>
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  <label for="Title">PostTitle Thai</label>
                  <textarea name="postTitle_th" class="form-control" required>{{$type->typeTitles[2]->title_th}}</textarea>
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <textarea name="subTitle_en" class="form-control" required>{{$type->typeTitles[1]->title_en}}</textarea>
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  <label for="inputTitle">PostTitle English</label>
                  <textarea name="postTitle_en" class="form-control" required>{{$type->typeTitles[2]->title_en}}</textarea>
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <textarea name="subTitle_ch" class="form-control" required>{{$type->typeTitles[1]->title_ch}}</textarea>
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  <label for="inputTitle">PostTitle Chinese</label>
                  <textarea name="postTitle_ch" class="form-control" required>{{$type->typeTitles[2]->title_ch}}</textarea>
                </div>
              </div>
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              ...
              <a href="{{route('benefit.create')}}" class="btn btn-primary">
                <i class="fas fa-plus"></i> Add
              </a>

              <div class="card-body">
                <h3 class="card-title">Welfare Benefit Post <b> EMBRYO</b></h3>
                      ...
                      <td>
                        <div class="btn-group">
                          ...
                          <div class="dropdown-menu" role="menu">
                            <a class="dropdown-item" href="{{route('benefit.update',$post->id)}}">Edit</a>
                            <a class="dropdown-item delete-row" href="{{route('benefit.destroy',$post->id)}}" id="delete-post-{{$post->id}}">Delete</a>
                          </div>
                      </td>
                    </tr>
                    @endforeach
  ...
  $(document).ready(function() {
    ...
    $('.delete-row').click(function(event) {
      ...
      if (confirm("Are you sure you want to delete this row?")) {
        ...
        window.location.href = "{{ route('benefit.destroy', ':id') }}".replace(':id', postId);
      }
    });
  });
