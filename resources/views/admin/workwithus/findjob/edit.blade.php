...
<div class="content-wrapper">
  ...
  <section class="content">
    <div class="container-fluid">
      ...
      <form action='{{route('findjob.edit')}}' method="post" enctype="multipart/form-data" id='regform'>
        @csrf
       <input type="hidden" name="post_id" value="{{$post->id}}"> 
          <div class="col-md-12">
            <div class="card card-default">
              <div class="card-header">
                <h3 class="card-title">Edit Job  Positions</h3>
              </div>
                  ...
                  <div class="bs-stepper-header" role="tablist">
                    ...
                    <div class="step" data-target="#profile-part">
                      <button type="button" class="step-trigger" role="tab" aria-controls="logins-part" id="logins-part-trigger">
                        ...
                        <span class="bs-stepper-label">Edit Banner Photo And Job Title</span>
                      </button>
                    </div>
                    <div class="line"></div>
                    <div class="step" data-target="#title-part">
                      <button type="button" class="step-trigger" role="tab" aria-controls="information-part" id="information-part-trigger">
                        ...
                        <span class="bs-stepper-label">Edit Job Description</span>
                      </button>
                    </div>
                       ...
                       <div class="row">   
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name='title_th' id="inputTitle"  value="{{$post->titles[0]->title_th}}" required>
                              </div>
                            </div>   
                          <div class="col-sm-4">
                            <div class="form-group">
                                <label>Title (English)</label>
                                <input type="text" class="form-control" name='title_en' id="inputTitle" placeholder="Enter Title..." value="{{$post->titles[0]->title_en}}" required>
                              </div>
                            </div>
                          <div class="col-sm-4">
                            <div class="form-group">
                                <label>Title (Chinese)</label>
                                <input type="text" class="form-control" name='title_ch' id="inputTitle" placeholder="Enter Title..." value="{{$post->titles[0]->title_ch}}" required>
                              </div>
                            </div>
                      </div>
                      <div class="row">   
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name='loca_th' id="inputTitle" placeholder="Enter Location..." value="{{$post->titles[1]->title_th}}" required>
                              </div>
                            </div>   
                          <div class="col-sm-4">
                            <div class="form-group">
                                <label>Location (English)</label>
                                <input type="text" class="form-control" name='loca_en' id="inputTitle" placeholder="Enter Location..."value="{{$post->titles[1]->title_en}}" required>
                              </div>
                            </div>
                          <div class="col-sm-4">
                            <div class="form-group">
                                <label>Location (Chinese)</label>
                                <input type="text" class="form-control" name='loca_ch' id="inputTitle" placeholder="Enter Location..."value="{{$post->titles[1]->title_ch}}" required>
                              </div>
                            </div>
                      </div>
                        <div class="row">
                                      ...
                                      <div class="row">   
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                              ...
                                              <textarea id="summernote" name="desc_th" class="form-control"required  >{{$post->contents[0]->content_en}}</textarea>
                                            </div>
                                          </div>
                                      </div>
                                      <div class="row">   
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                              ...
                                              <textarea id="summernote1" name="desc_en" class="form-control"required  >{{$post->contents[0]->content_th}}</textarea>
                                            </div>
                                          </div>
                                      </div>
                                      <div class="row">   
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                              ...
                                              <textarea id="summernote2" name="desc_ch" class="form-control"required  >{{$post->contents[0]->content_ch}}</textarea>
                                            </div>
                                          </div>
                                      </div>
                                    </div>
