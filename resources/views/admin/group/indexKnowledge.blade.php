@extends('layout.app')
@section('title') New And Knowledge @endsection
@section('contents')
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">New And Knowledge</h1>
        </div><!-- /.col -->
          ...
          <div class="card card-primary card-outline">
            <div class="card-header">
              <h3 class="card-title">
                ...
                Edit New and Knowledge Image
              </h3>
            </div>

            <div class="card-body">
              <form action='{{route('knowledge.editImage')}}' method="post" enctype="multipart/form-data" id='regform'>
                @csrf
